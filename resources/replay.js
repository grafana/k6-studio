;(function () {
  ...
  function getUntaintedPrototype$1(key) {
    ...
    const accessorNames =
      key in testableAccessors$1 ? testableAccessors$1[key] : void 0
    const isUntaintedAccessors = Boolean(
      ...
      accessorNames.every((accessor) => {
        ...
        return Boolean(
          (_b =
            (_a2 = Object.getOwnPropertyDescriptor(
              defaultPrototype,
              accessor
            )) == null
              ? void 0
    ...
    const methodNames =
      key in testableMethods$1 ? testableMethods$1[key] : void 0
  ...
  function getUntaintedAccessor$1(key, instance, accessor) {
    ...
    const untaintedAccessor =
      (_a2 = Object.getOwnPropertyDescriptor(untaintedPrototype, accessor)) ==
      null
        ? void 0
        : _a2.get
  ...
  function stringifyStylesheet(s2) {
    try {
      ...
      const stringifiedRules = Array.from(rules2, (rule2) =>
        stringifyRule(rule2, sheetHref)
      ).join('')
    ...
    if (childNodes2.length > 1 && cssText && typeof cssText === 'string') {
      ...
      for (let i2 = 1; i2 < childNodes2.length; i2++) {
        if (
          ...
          typeof childNodes2[i2].textContent === 'string'
        ) {
          ...
          for (let j = 3; j < textContentNorm.length; j++) {
            ...
            if (cssTextNorm.split(bit).length === 2) {
              ...
              for (let k = splitNorm; k < cssText.length; k++) {
                if (
                  normalizeCssString(cssText.substring(0, k)).length ===
                  splitNorm
                ) {
  ...
  function getHref(doc, customHref) {
    ...
    if (!customHref) {
      ...
      customHref.startsWith('blob:') ||
      customHref.startsWith('data:')
    ) {
      return customHref
    }
  ...
  function serializeElementNode(n2, options) {
    ...
    if (tagName === 'dialog' && n2.open) {
      attributes.rr_open_mode = n2.matches('dialog:modal')
        ? 'modal'
        : 'non-modal'
    }
      ...
      if (
        ...
        (sn.tagName === 'script' || // (module)preload link
          (sn.tagName === 'link' &&
            ...
            sn.attributes.as === 'script') || // prefetch link
          (sn.tagName === 'link' &&
  ...
  function serializeNodeWithId(n2, options) {
    ...
    if (
      (serializedNode.type === NodeType$3.Document ||
  ...
  const require$$2$1 = /* @__PURE__ */ getAugmentedNamespace$1(
    __viteBrowserExternal$1$1
  )
  ...
  let {
    SourceMapConsumer: SourceMapConsumer$2$1,
    SourceMapGenerator: SourceMapGenerator$2$1,
  } = require$$2$1
  ...
  let {
    SourceMapConsumer: SourceMapConsumer$1$1,
    SourceMapGenerator: SourceMapGenerator$1$1,
  } = require$$2$1
  let { fileURLToPath: fileURLToPath$1, pathToFileURL: pathToFileURL$1$1 } =
    require$$2$1
  ...
  let sourceMapAvailable$1$1 = Boolean(
    SourceMapConsumer$1$1 && SourceMapGenerator$1$1
  )
  ...
  let sourceMapAvailable$2 = Boolean(
    SourceMapConsumer$3 && SourceMapGenerator$3
  )
    ...
    raw(node2, prop, tokens, customProperty) {
      ...
      for (let i2 = 0; i2 < length; i2 += 1) {
        ...
        if (type === 'space' && i2 === length - 1 && !customProperty) {
          ...
          if (
            !SAFE_COMMENT_NEIGHBOR$1[prev] &&
            !SAFE_COMMENT_NEIGHBOR$1[next]
          ) {
            if (value.slice(-1) === ',') {
              clean = false
            } else {
          ...
          for (let [plugin22, visitor] of this.listeners.OnceExit) {
            ...
            try {
              if (root2.type === 'document') {
                let roots = root2.nodes.map((subRoot) =>
      ...
      try {
        if (typeof plugin22 === 'object' && plugin22.Once) {
          if (this.result.root.type === 'document') {
            let roots = this.result.root.nodes.map((root2) =>
              plugin22.Once(root2, this.helpers)
            )
  ...
  let sourceMapAvailable$1 = Boolean(
    SourceMapConsumer$1 && SourceMapGenerator$1
  )
  ...
  function getUntaintedPrototype(key) {
    ...
    const defaultPrototype = defaultObj.prototype
    const accessorNames =
      key in testableAccessors ? testableAccessors[key] : void 0
    const isUntaintedAccessors = Boolean(
      accessorNames && // @ts-expect-error 2345
      accessorNames.every((accessor) => {
        var _a2, _b
        ...
        : win.pageXOffset !== void 0
          ...
          : doc.documentElement.scrollLeft ||
            ((doc == null ? void 0 : doc.body) &&
              ((_a2 = index.parentElement(doc.body)) == null
                ? void 0
                : _a2.scrollLeft)) ||
            ((_b = doc == null ? void 0 : doc.body) == null
              ? void 0
              : _b.scrollLeft) ||
            0,
      top: doc.scrollingElement
        ...
        : win.pageYOffset !== void 0
          ...
          : (doc == null ? void 0 : doc.documentElement.scrollTop) ||
            ((doc == null ? void 0 : doc.body) &&
              ((_c = index.parentElement(doc.body)) == null
                ? void 0
                : _c.scrollTop)) ||
            ((_d = doc == null ? void 0 : doc.body) == null
              ? void 0
              : _d.scrollTop) ||
            0,
    }
  ...
  function closestElementOfNode(node2) {
    ...
    const el =
      node2.nodeType === node2.ELEMENT_NODE ? node2 : index.parentElement(node2)
    return el
  }
        ...
        while (addList.length) {
          ...
          if (candidate) {
            const parentId = this.mirror.getId(
              index.parentNode(candidate.value)
            )
  ...
  function initStyleSheetObserver(
    { styleSheetRuleCb, mirror: mirror2, stylesheetManager },
    { win }
  ) {
  ...
  function initAdoptedStyleSheetObserver(
    { mirror: mirror2, stylesheetManager },
    host2
  ) {
    var _a2, _b, _c
    let hostId = null
    ...
    const patchTarget =
      host2.nodeName === '#document'
        ? (_a2 = host2.defaultView) == null
          ? void 0
          : _a2.Document
        : (_c = (_b = host2.ownerDocument) == null ? void 0 : _b.defaultView) ==
            null
          ? void 0
          : _c.ShadowRoot
    ...
    Object.defineProperty(host2, 'adoptedStyleSheets', {
      ...
      get() {
        var _a3
        return (_a3 = originalPropertyDescriptor.get) == null
          ? void 0
          : _a3.call(this)
      },
      set(sheets) {
        var _a3
        const result2 =
          (_a3 = originalPropertyDescriptor.set) == null
            ? void 0
            : _a3.call(this, sheets)
    ...
    addShadowRoot(shadowRoot2, doc) {
      ...
      setTimeout(() => {
        if (
          ...
          shadowRoot2.adoptedStyleSheets.length > 0
        )
  ...
  const decodeBase64 = (base64) =>
    Uint8Array.from(atob(base64), (c2) => c2.charCodeAt(0))
  const blob =
  ...
  class ProcessedNodeManager {
    ...
    add(node2, buffer) {
      ...
      this.nodeMap.set(
        node2,
        (this.nodeMap.get(node2) || /* @__PURE__ */ new Set()).add(buffer)
      )
    }
    destroy() {}
  }
  ...
  try {
    if (Array.from([1], (x2) => x2 * 2)[0] !== 2) {
      ...
      Array.from =
        ((_a = cleanFrame.contentWindow) == null ? void 0 : _a.Array.from) ||
        Array.from
    ...
    wrappedEmit = (r2, isCheckout) => {
      ...
      if (
        ...
        !(
          ...
          e2.data.source === IncrementalSource.Mutation
        )
      ) {
      ...
      if (e2.type === EventType.FullSnapshot) {
        ...
        const exceedTime =
          checkoutEveryNms &&
          e2.timestamp - lastFullSnapshotEvent.timestamp > checkoutEveryNms
