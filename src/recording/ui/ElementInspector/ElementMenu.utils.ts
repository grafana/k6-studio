import { getEventTarget } from '@/recording/target'
import { ElementRole, getElementRoles } from '@/recording/utils/aria'
import { findAssociatedElement } from '@/recording/utils/dom'
